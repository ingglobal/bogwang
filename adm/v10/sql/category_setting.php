        ...
        for($row = 0; $row < $highestRow; $row++) {
			...
			if(
				...
				if(gettype($catArr[$rowData[0][1]][$rowData[0][2]][$rowData[0][3]][$rowData[0][4]]) != 'array'){
					...
					$catArr[$rowData[0][1]]['subs'][$rowData[0][2]]['subs'][$rowData[0][3]]['subs'][$rowData[0][4]]['item'] = array();
					
				}
				

				$catArr[$rowData[0][1]]['subs'][$rowData[0][2]]['subs'][$rowData[0][3]]['subs'][$rowData[0][4]]['item']['bom_part_no'] = $rowData[0][5];
				$catArr[$rowData[0][1]]['subs'][$rowData[0][2]]['subs'][$rowData[0][3]]['subs'][$rowData[0][4]]['item']['bom_name'] = $rowData[0][6];
				$catArr[$rowData[0][1]]['subs'][$rowData[0][2]]['subs'][$rowData[0][3]]['subs'][$rowData[0][4]]['item']['bom_ex_label'] = $rowData[0][25];
...
/*
//BOM완성품 [bom_part_no]근거로 (품명/외부라벨)수정
							
$isql = " INSERT INTO {$g5['bom_table']} (`com_idx`,`com_idx_provider`,`com_idx_customer`,`bct_id`,`bom_name`,`bom_part_no`,`bom_mark`,`bom_type`,`bom_ex_label`,`bom_status`,`bom_reg_dt`,`bom_update_dt`) VALUES (
	'{$_SESSION['ss_com_idx']}'
	,'{$_SESSION['ss_com_idx']}'
	,'0'
	,'".$catArr[$c1k]['subs'][$c2k]['subs'][$c3k]['bct_id'].$idArr[$c4]."'
	,'{$catArr[$c1k]['subs'][$c2k]['subs'][$c3k]['subs'][$c4k]['item']['bom_name']}'
	,'{$catArr[$c1k]['subs'][$c2k]['subs'][$c3k]['subs'][$c4k]['item']['bom_part_no']}'
	,'{$bom_mark}'
	,'product'
	,'{$catArr[$c1k]['subs'][$c2k]['subs'][$c3k]['subs'][$c4k]['item']['bom_ex_label']}'
	,'ok'
	,'".G5_TIME_YMDHIS."'
	,'".G5_TIME_YMDHIS."'
)
ON DUPLICATE KEY
UPDATE
	bct_id = '".$catArr[$c1k]['subs'][$c2k]['subs'][$c3k]['bct_id'].$idArr[$c4]."'
	,bom_name = '{$catArr[$c1k]['subs'][$c2k]['subs'][$c3k]['subs'][$c4k]['item']['bom_name']}'
	,bom_mark = '{$bom_mark}'
	,bom_ex_label = '{$catArr[$c1k]['subs'][$c2k]['subs'][$c3k]['subs'][$c4k]['item']['bom_ex_label']}'
	,bom_update_dt = '".G5_TIME_YMDHIS."'
