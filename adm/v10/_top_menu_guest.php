...
<h2 id="container_sub_title">
	<a href="./data_item_sum_list.php" class="btn_top_menu '.$active_guest_item_list.'"></a>
	<a href="./data_item_list.php" class="btn_top_menu '.$active_guest_item_row_list.'">상세생산데이터</a>
	'.$sub_title_term_list.'
</h2>
';
?>
